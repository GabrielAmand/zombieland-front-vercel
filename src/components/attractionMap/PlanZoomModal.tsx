  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => e.stopPropagation()} // 👈 empêche que l'intérieur ferme la modale
      >
        {/* Croix de fermeture, placée tout en haut */}
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 z-[60] text-white hover:text-red-500 transition"
          aria-label="Fermer"
        >
          <X size={32} />
        </button>
